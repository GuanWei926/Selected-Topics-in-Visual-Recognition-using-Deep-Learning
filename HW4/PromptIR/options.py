...
parser.add_argument(
    '--batch_size', type=int, default=8, help="Batch size to use per GPU")
parser.add_argument(
    '--lr', type=float, default=2e-4, help='learning rate of encoder.')
...
parser.add_argument(
    ...
    default=[
        ...
        'derain', 'dehaze', 'desnow'
    ],
    help='Which types of degradations are used for training and testing.'
)

parser.add_argument(
    '--patch_size', type=int, default=128, help='patchsize of input.')
parser.add_argument(
